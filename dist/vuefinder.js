...
var cr = (t, e, n) =>
  e in t
    ? ir(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n })
    : (t[e] = n);
...
import {
  ...
  computed as Fe,
  readonly as ur,
  getCurrentScope as vr,
  onScopeDispose as fr,
  unref as r,
  getCurrentInstance as _r,
  inject as re,
  openBlock as f,
  ...
  withModifiers as ot,
  renderSlot as Tt,
  normalizeClass as le,
  toDisplayString as w,
  createBlock as K,
  resolveDynamicComponent as Ps,
  withCtx as Q,
  createVNode as z,
  Fragment as ge,
  renderList as ye,
  createCommentVNode as I,
  withDirectives as ue,
  vModelCheckbox as jt,
  ...
  vShow as Pe,
  isRef as pr,
  TransitionGroup as hr,
  mergeModels as Qt,
  useModel as Mt,
  normalizeStyle as dn,
  resolveComponent as gr,
  provide as br,
  Transition as wr
} from "vue";
import yr from "mitt";
...
var Ns;
const $n =
  (Ns = document.querySelector('meta[name="csrf-token"]')) == null
    ? void 0
    : Ns.getAttribute("content");
class Er {
  ...
  transformRequestParams(e) {
    ...
    const s = Object.assign({}, n.headers, o, e.headers),
      c = Object.assign({}, n.params, e.params),
      a = e.body,
      d = n.baseUrl + e.url,
      i = e.method;
    let u;
    i !== "get" &&
      (a instanceof FormData
        ? ((u = a),
          n.body != null &&
            Object.entries(this.config.body).forEach(([v, m]) => {
              u.append(v, m);
            }))
        : ((u = { ...a }),
          n.body != null && Object.assign(u, this.config.body)));
    const _ = {
      url: d,
      method: i,
      headers: s,
    ...
    if (n.transformRequest != null) {
      ...
      v.url != null && (_.url = v.url),
        v.method != null && (_.method = v.method),
        v.params != null && (_.params = v.params ?? {}),
        v.headers != null && (_.headers = v.headers ?? {}),
        v.body != null && (_.body = v.body);
    }
    return _;
  }
  /**
   ...
   */
  async send(e) {
    const n = this.transformRequestParams(e),
      o = e.responseType || "json",
      s = {
        method: e.method,
        headers: n.headers,
    ...
    if (n.method !== "get" && n.body != null) {
      ...
      n.body instanceof FormData
        ? (d = e.body)
        : ((d = JSON.stringify(n.body)),
          (s.headers["Content-Type"] = "application/json")),
        (s.body = d);
    }
    const a = await fetch(c, s);
    if (a.ok) return await a[o]();
    throw await a.json();
  }
}
function Ar(t) {
...
function Tr(t) {
  ...
  function o() {
    Object.keys(n).length
      ? localStorage.setItem(t + "_storage", JSON.stringify(n))
      : localStorage.removeItem(t + "_storage");
  }
  function s(i, u) {
    n[i] = u;
  }
  ...
  return {
    getStore: (i, u = null) => (n.hasOwnProperty(i) ? n[i] : u),
    setStore: s,
    removeStore: c,
    clearStore: a
  };
...
function Dr(t, e, n, o) {
        ...
        .then(p => {
          (a.value = p),
            ...
            Object.values(o).length > 1 &&
              (n.emit("vf-toast-push", {
                label: "The language is set to " + v
              }),
              n.emit("vf-language-saved"));
        })
        .catch(p => {
          m
            ? (n.emit("vf-toast-push", {
  ...
  const u = (v, ...m) =>
    m.length ? u((v = v.replace("%s", m.shift())), ...m) : v;
  function _(v, ...m) {
    return a.value && a.value.hasOwnProperty(v)
      ? u(a.value[v], ...m)
      : u(v, ...m);
  }
...
function Fr(t, e) {
  ...
  const s = window.matchMedia("(prefers-color-scheme: dark)"),
    c = a => {
      n.value === nt.DARK || (n.value === nt.SYSTEM && a.matches)
        ? (o.value = nt.DARK)
        : (o.value = nt.LIGHT);
    };
  return (
    ...
    s.addEventListener("change", c),
    {
      ...
      set(a) {
        (n.value = a),
          a !== nt.SYSTEM ? t.setStore("theme", a) : t.removeStore("theme"),
          c(s);
      }
    }
  );
...
const Oe = (t, e) => {
  ...
  Br = typeof window < "u" && typeof HTMLElement < "u" && !!window.document,
  De = Br ? window : {},
  Gs = Math.max,
  Hr = Math.min,
  On = Math.round,
  en = Math.abs,
  hs = Math.sign,
  Ws = De.cancelAnimationFrame,
  Jn = De.requestAnimationFrame,
  tn = De.setTimeout,
  Vn = De.clearTimeout,
  un = t => (typeof De[t] < "u" ? De[t] : void 0),
  Ir = un("MutationObserver"),
  gs = un("IntersectionObserver"),
  nn = un("ResizeObserver"),
  Yt = un("ScrollTimeline"),
  Xn = t => t === void 0,
  vn = t => t === null,
  qe = t => typeof t == "number",
  Ft = t => typeof t == "string",
  Zn = t => typeof t == "boolean",
  He = t => typeof t == "function",
  je = t => Array.isArray(t),
  sn = t => typeof t == "object" && !je(t) && !vn(t),
  Qn = t => {
    const e = !!t && t.length,
      n = qe(e) && e > -1 && e % 1 == 0;
    return je(t) || (!He(t) && n) ? (e > 0 && sn(t) ? e - 1 in t : !0) : !1;
  },
  on = t => !!t && t.constructor === Object,
  rn = t => t instanceof HTMLElement,
  fn = t => t instanceof Element;
function ae(t, e) {
  if (Qn(t)) for (let n = 0; n < t.length && e(t[n], n, t) !== !1; n++);
  else t && ae(Object.keys(t), n => e(t[n], n, t));
  return t;
}
const Ks = (t, e) => t.indexOf(e) >= 0,
  Dt = (t, e) => t.concat(e),
  me = (t, e, n) => (
    !Ft(e) && Qn(e) ? Array.prototype.push.apply(t, e) : t.push(e), t
  ),
  lt = t => Array.from(t || []),
  es = t => (je(t) ? t : !Ft(t) && Qn(t) ? lt(t) : [t]),
  Ln = t => !!t && !t.length,
  Fn = t => lt(new Set(t)),
  Re = (t, e, n) => {
  ...
  ro = (t, e) => Object.prototype.hasOwnProperty.call(t, e),
  Ie = t => (t ? Object.keys(t) : []),
  oe = (t, e, n, o, s, c, a) => {
    const d = [e, n, o, s, c, a];
    return (
      (typeof t != "object" || vn(t)) && !He(t) && (t = {}),
      ae(d, i => {
        ae(i, (u, _) => {
          const v = i[_];
          if (t === v) return !0;
  ...
  ts = t => !Ie(t).length,
  ao = (t, e, n) => Gs(t, Hr(e, n)),
  vt = t => Fn((je(t) ? t : (t || "").split(" ")).filter(e => e)),
  ns = (t, e) => t && t.getAttribute(e),
  bs = (t, e) => t && t.hasAttribute(e),
  Xe = (t, e, n) => {
    ae(vt(e), o => {
  ...
  io = (t, e, n) => (hn(t, e).O(n), J(ss, t, e, n)),
  ss = (t, e, n) => (hn(t, e).$(n), J(io, t, e, n)),
  ln = (t, e, n, o) => (o ? ss : io)(t, e, n),
  os = (t, e, n) => hn(t, e).C(n),
  co = t => hn(t, "class"),
  uo = (t, e) => {
    co(t).O(e);
  },
  rs = (t, e) => (co(t).$(e), J(uo, t, e)),
  vo = (t, e) => {
  ...
  Bn = (t, e) => fn(t) && t.matches(e),
  fo = t => Bn(t, "body"),
  Hn = t => (t ? lt(t.childNodes) : []),
  Ot = t => t && t.parentElement,
  pt = (t, e) => fn(t) && t.closest(e),
  In = t => document.activeElement,
  zr = (t, e, n) => {
    const o = pt(t, e),
      s = t && Pr(n, o),
      c = pt(s, e) === o;
  ...
  ws = (t, e) => t.getPropertyValue(e) || t[e] || "",
  mo = t => {
    const e = t || 0;
    return isFinite(e) ? e : 0;
  },
  Gt = t => mo(parseFloat(t || "")),
  Nn = t => Math.round(t * 1e4) / 1e4,
  po = t => `${Nn(mo(t))}px`;
function Vt(t, e) {
  t &&
    e &&
...
const ys = (t, e, n) => {
  ...
  qr = (t, e) => `translate${sn(t) ? `(${t.x},${t.y})` : `Y(${t})`}`,
  jr = t => !!(t.offsetWidth || t.offsetHeight || t.getClientRects().length),
  Gr = {
    w: 0,
    h: 0
  },
  ...
  an = J(gn, "scroll"),
  ls = t => {
    const e = parseFloat(Qe(t, _n)) || 0,
      n = parseFloat(Qe(t, mn)) || 0;
    return {
      w: e - On(e),
      h: n - On(n)
    };
  },
  Cn = t => t.getBoundingClientRect(),
  Kr = t => !!t && jr(t),
  Un = t => !!(t && (t[mn] || t[_n])),
  go = (t, e) => {
    const n = Un(t);
  ...
  Es = (t, e) =>
    t
      ? `${e}`.split(".").reduce((n, o) => (n && ro(n, o) ? n[o] : void 0), t)
      : void 0,
  Jr = {
    paddingAbsolute: !1,
  ...
  ko = (t, e) => {
    ...
    return (
      ae(o, s => {
        const c = t[s],
          a = e[s];
        if (sn(c) && sn(a)) oe((n[s] = {}), ko(c, a)), ts(n[s]) && delete n[s];
        else if (ro(e, s) && a !== c) {
          let d = !0;
          if (je(c) || je(a))
            try {
  ...
  As = (t, e, n) => o => [Es(t, o), n || Es(e, o) !== void 0],
  xt = "data-overlayscrollbars",
  Xt = "os-environment",
  Wt = `${Xt}-scrollbar-hidden`,
  En = `${xt}-initialize`,
  Zt = "noClipping",
  Ts = `${xt}-body`,
  rt = xt,
...
const pl = () => {
    const t = (S, O, L) => {
      ...
      e = S => {
        ...
        try {
          O =
            Qe(S, "scrollbar-width") === "none" ||
            Qe(S, "display", "::-webkit-scrollbar") === "none";
        } catch {}
        return L(), O;
      },
      n = `.${Xt}{scroll-behavior:auto!important;position:fixed;opacity:0;visibility:hidden;overflow:scroll;height:200px;width:200px;z-index:-1}.${Xt} div{width:200%;height:200%;margin:10px 0}.${Wt}{scrollbar-width:none!important}.${Wt}::-webkit-scrollbar,.${Wt}::-webkit-scrollbar-corner{appearance:none!important;display:none!important;width:0!important;height:0!important}`,
      s = _o(`<div class="${Xt}"><div></div><style>${n}</style></div>`)[0],
      c = s.firstChild,
      a = s.lastChild,
      d = _l();
    d && (a.nonce = d);
  ...
  gl = (t, e) => {
    const { nativeScrollbarsOverlaid: n, body: o } = e || {},
      { k: s, R: c, U: a } = We(),
      { nativeScrollbarsOverlaid: d, body: i } = a().cancel,
      u = n ?? d,
      _ = Xn(o) ? i : o,
      v = (s.x || s.y) && u,
      m = t && (vn(_) ? !c : _);
  ...
  yl = (t, e, n) => {
    let o = !1;
    const s = n ? /* @__PURE__ */ new WeakMap() : !1,
      c = () => {
        o = !0;
      },
      a = d => {
  ...
  Fs = (t, e, n, o) => {
    let s = !1;
    const { j: c, X: a, Y: d, W: i, J: u, G: _ } = o || {},
      v = Rn(() => s && n(!0), {
        _: 33,
        v: 99
      }),
      ...
      E = (k, S) => {
        if (!Ln(S)) {
          ...
          if (
            ...
            p(A =>
              Fn(G).reduce(
                (T, R) => (me(T, vo(A, R)), Bn(R, A) ? me(T, R) : T),
                []
              )
            ),
            e)
    ...
    return [
      ...
      () => {
        if (s) return v.m(), E(!0, H.takeRecords());
      }
    ];
  },
  Mo = {},
  ...
  Rt = t => Do[t],
  Sl = "__osOptionsValidationPlugin",
  xl = "__osSizeObserverPlugin",
  $l = (t, e) => {
    const { k: n } = e,
      [o, s] = t("showNativeOverlaidScrollbars");
    return [o && n.x && n.y, s];
  },
  yt = t => t.indexOf(st) === 0,
  Cl = (t, e) => {
    const n = (s, c, a, d) => {
        const i = s === st ? ct : s.replace(`${st}-`, ""),
          u = yt(s),
          _ = yt(a);
        return !c && !d
          ? ct
  ...
  Vo = "__osScrollbarsHidingPlugin",
  El = "__osClickScrollPlugin",
  Lo = (t, e, n) => {
    const { dt: o } = n || {},
      s = Rt(xl),
      [c] = Oe({
    ...
    return () => {
      const a = [],
        i = _o(`<div class="${as}"><div class="${ol}"></div></div>`)[0],
        u = i.firstChild,
        _ = v => {
  ...
  Al = (t, e) => {
    let n;
    const o = i => i.h === 0 || i.isIntersecting || i.intersectionRatio > 0,
      s = ht(rl),
      [c] = Oe({
        o: !1
      }),
  ...
  Tl = (t, e, n, o) => {
    ...
    return [
      ...
      ({ It: D, At: W, Dt: j }) => {
        const Y = {},
          [te] = D("update.ignoreMutation"),
          [ie, be] = D("update.attributes"),
          [fe, $e] = D("update.elementEvents"),
          [Z, Ce] = D("update.debounce"),
          Ae = $e || be,
          ke = W || j,
          Ee = he => He(te) && te(he);
        if (Ae) {
  ...
  Ml = (t, e, n, o) => {
    const s = "--os-viewport-percent",
      c = "--os-scroll-percent",
      a = "--os-scroll-direction",
      { U: d } = We(),
      { scrollbars: i } = d(),
      { slot: u } = i,
      { vt: _, ht: v, ot: m, Mt: p, gt: g, wt: h, nt: y } = e,
      { scrollbars: E } = p ? {} : t,
      { slot: H } = E || {},
      k = [],
      S = [],
      O = [],
      L = Ao([_, v, m], () => (y && h ? _ : v), u, H),
      G = F => {
        if (Yt) {
          const B = new Yt({
            source: g,
      ...
      ee = F => {
        ...
        return (
          me(F ? S : O, j),
          me(k, [Ve(q, D), Ve(D, W), J(wt, q), Y && Y.kt(j), o(j, T, F)]),
          j
        );
      },
      se = J(ee, !0),
      ne = J(ee, !1),
      pe = () => (Ve(L, S[0].Tt), Ve(L, O[0].Tt), J(Re, k));
    return (
      se(),
      ne(),
      [
  ...
  Dl = (t, e, n, o) => (s, c, a) => {
    const { ht: d, ot: i, nt: u, gt: _, Kt: v, Ot: m } = e,
      { Tt: p, Ut: g, Pt: h } = s,
      [y, E] = mt(333),
      [H, k] = mt(444),
      S = G => {
      ...
      O = () => {
        const G = "pointerup pointercancel lostpointercapture",
          V = `client${a ? "X" : "Y"}`,
          $ = a ? _n : mn,
          x = a ? "left" : "top",
          A = a ? "w" : "h",
        ...
        return ve(g, "pointerdown", U => {
          const P = pt(U.target, `.${is}`) === h,
            ee = P ? h : g,
            se = t.scrollbars,
            ne = se[P ? "dragScroll" : "clickScroll"],
            { button: pe, isPrimary: F, pointerType: B } = U,
            { pointers: N } = se;
          if (pe === 0 && F && ne && (N || []).includes(B)) {
            Re(C), k();
            const D = !P && (U.shiftKey || ne === "instant"),
              W = J(Cn, h),
              j = J(Cn, g),
              Y = (_e, Se) => (_e || W())[x] - (Se || j())[x],
              te = On(Cn(_)[$]) / gt(_)[A] || 1,
              ie = R(Le(_)[T], 1 / te),
              be = U[V],
              fe = W(),
              ...
              ce = [
                ve(v, G, Ee),
                ve(v, "selectstart", _e => Pn(_e), {
                  H: !1
                }),
                ve(g, G, Ee),
                he && ve(g, "pointermove", _e => ie(ke + (_e[V] - be))),
                he &&
                  (() => {
                    const _e = Le(_);
                    we();
            ...
            if ((ee.setPointerCapture(U.pointerId), D)) ie(ke);
            else if (!P) {
              const _e = Rt(El);
              if (_e) {
    ...
    let L = !0;
    return J(Re, [
      ve(h, "pointermove pointerleave", o),
      ve(p, "pointerenter", () => {
        c(Ds, !0);
      }),
  ...
  Ol = (t, e, n, o, s, c) => {
    ...
    return [
      () => J(Re, me(pe, G())),
      ({ It: F, Dt: B, Zt: N, tn: q }) => {
        const { nn: D, sn: W, en: j, cn: Y } = q || {},
          { Ct: te, dt: ie } = N || {},
          { ct: be } = n,
          { k: fe } = We(),
          { K: $e, rn: Z } = o,
          [Ce, Ae] = F("showNativeOverlaidScrollbars"),
          [ke, Ee] = F("scrollbars.theme"),
          [he, we] = F("scrollbars.visibility"),
          [ce, _e] = F("scrollbars.autoHide"),
          [Se, Te] = F("scrollbars.autoHideSuspend"),
          [$t] = F("scrollbars.autoHideDelay"),
          [Bt, Ht] = F("scrollbars.dragScroll"),
          [It, at] = F("scrollbars.clickScroll"),
          [ft, wn] = F("overflow"),
          yn = ie && !B,
          kn = Z.x || Z.y,
          Sn = D || W || Y || te || B,
          ...
          Ct = (Et, tt, Nt) => {
            const At =
              Et.includes(bt) && (he === st || (he === "auto" && tt === bt));
  ...
  Vl = t => {
    const e = We(),
      { U: n, R: o } = e,
      { elements: s } = n(),
      { padding: c, viewport: a, content: d } = s,
      i = rn(t),
      u = i ? {} : t,
      { elements: _ } = u,
      { padding: v, viewport: m, content: p } = _ || {},
      g = i ? t : u.target,
      h = fo(g),
      y = g.ownerDocument,
      E = y.documentElement,
    ...
    return [
      ...
      () => {
        const Z = H(),
          ...
          ke = ce =>
            ve(ce, "focusin focusout focus blur", wo, {
              I: !0,
              H: !1
            }),
          Ee = "tabindex",
        ...
        return (
          ...
          o && !x && (ss(j, Ze, xo), me(te, J(Ue, j, Ze))),
          zn(!x && h && Ce === q && Z.top === Z ? j : Ce),
          we(),
          (ie = 0),
          fe
        );
  ...
  Rl = (t, e) => {
    const n = We(),
      { ht: o, ln: s, ot: c, nt: a, Qt: d, gt: i, wt: u, St: _, un: v } = t,
      { R: m } = n,
      p = u && a,
      g = J(Gs, 0),
      h = {
      ...
      O = (B, N) => {
        const q = De.devicePixelRatio % 1 !== 0 ? 1 : 0,
          D = {
            w: g(B.w - N.w),
            h: g(B.h - N.h)
          };
      ...
      pe = (B, N) => `${N ? Zr : Qr}${Nr(B)}`,
      F = B => {
        const N = D => [st, ct, bt].map(W => pe(W, D)),
          q = N(!0).concat(N()).join(" ");
        _(q),
          _(
            Ie(B)
    ...
    return ({ It: B, Zt: N, _n: q, Dt: D }, { fn: W }) => {
      const { ft: j, Ht: Y, Ct: te, dt: ie, zt: be } = N || {},
        fe = ne && ne.tt(t, e, q, n, B),
        { it: $e, ut: Z, _t: Ce } = fe || {},
        [Ae, ke] = $l(B, n),
        [Ee, he] = B("overflow"),
        we = yt(Ee.x),
      ...
      const [Ht, It] = Bt,
        ...
        Ct =
          ...
          (we && Ne.x && !Ne.y) ||
          (ce && Ne.y && !Ne.x),
        Et = W || te || be || Sn || yn || It || ft || he || ke || _e,
        tt = Cl(Ne, Ee),
        [Nt, At] = U(tt.K),
        [sr, or] = P(D),
        fs = te || ie || or || xn || D,
        [rr, lr] = fs ? ee(S(sr), D) : se();
      return (
        Et && (At && F(tt.K), Ce && $e && Vt(c, Ce(tt, q, $e(tt, wn, kn)))),
        k(!1),
        ln(o, rt, Zt, Ct),
        ln(s, jn, Zt, Ct),
        oe(e, {
  ...
  Bl = t => {
    const [e, n, o] = Vl(t),
      ...
      { vt: c, gt: a, nt: d, Ot: i } = e,
      { R: u, k: _ } = We(),
      v = !u && (_.x || _.y),
      m = [Ll(e), Fl(e, s), Rl(e, s)];
    return [
      n,
      p => {
        const g = {},
  ...
  Hl = (t, e, n, o, s) => {
    ...
    const a = As(e, {}),
      ...
      [h, y, , E] = Ol(t, e, g, u, _, s),
      H = S => Ie(S).some(O => !!S[O]),
      k = (S, O) => {
        if (n()) return !1;
        const { pn: L, Dt: G, At: V, hn: $ } = S,
          x = L || {},
          A = !!G || !c,
          T = {
            It: As(e, x, A),
    ...
    if (e && !a) {
      ...
      const i = [],
        ...
        [k, S, O, L, G] = Hl(
          ...
          () => d,
          ({ pn: x, Dt: A }, { Zt: T, tn: R }) => {
            const { ft: C, Ct: U, xt: P, Ht: ee, Et: se, dt: ne } = T,
              { nn: pe, sn: F, en: B, cn: N } = R;
            H("updated", [
              $,
              {
                updateHints: {
        ...
        $ = {
          ...
          state() {
            const { gn: x, bn: A } = O(),
              { ct: T } = x,
              { Vt: R, Rt: C, K: U, rn: P, ln: ee, dn: se, Lt: ne } = A;
            return oe(
              {},
              {
                overflowEdge: R,
          ...
          elements() {
            const { vt: x, ht: A, ln: T, ot: R, bt: C, gt: U, Qt: P } = L.wn,
              { Xt: ee, Gt: se } = L.yn,
              ne = F => {
      ...
      return (
        ...
        bl(c, $),
        Oo(Mo, Ge, [$, m, u]),
        gl(L.wn.wt, !s && t.cancel)
          ? (V(!0), $)
          : (me(i, k()), H("initialized", [$]), $.update(), $)
      );
    }
    return a;
  };
...
function Il() {
  let t;
  const e = M(null),
    n = Math.floor(Math.random() * 2 ** 32),
    o = M(!1),
    s = M([]),
    c = () => s.value,
    a = () => t.getSelection(),
    d = () => s.value.length,
    i = () => t.clearSelection(!0),
    u = M(),
    _ = M(null),
    v = M(null),
    m = M(null),
  ...
  function g() {
    (t = new kr({
      ...
      t.subscribe("DS:start:pre", ({ items: O, event: L, isDragging: G }) => {
        if (G) t.Interaction._reset(L);
        else {
          o.value = !1;
          const V = e.value.offsetWidth - L.offsetX,
            $ = e.value.offsetHeight - L.offsetY;
          V < 15 && $ < 15 && t.Interaction._reset(L),
            L.target.classList.contains("os-scrollbar-handle") &&
  ...
  const h = () =>
    ...
    y = () => {
      (s.value = t.getSelection().map(O => JSON.parse(O.dataset.item))),
        u.value(s.value);
    },
    E = () =>
      dt(() => {
        ...
        i(),
          ...
          t.addSelection(
            t
              .getSelectables()
              .filter(L => O.includes(JSON.parse(L.dataset.item).path))
          ),
          y(),
          k();
      }),
    H = O => {
      (u.value = O),
        t.subscribe("DS:end", ({ items: L, event: G, isDragging: V }) => {
          (s.value = L.map($ => JSON.parse($.dataset.item))),
            O(
              ...
              $ => {
                typeof $ < "u" &&
                  (L.forEach(x => {
                    const A = JSON.parse(x.dataset.item),
                      T = $.find(R => R.path === A.path);
                    typeof T < "u" &&
    ...
    k = () => {
      _.value &&
        (e.value.getBoundingClientRect().height < e.value.scrollHeight
          ? ((v.value.style.height = e.value.scrollHeight + "px"),
            (v.value.style.display = "block"))
          : ((v.value.style.height = "100%"),
            (v.value.style.display = "none")));
    },
    S = O => {
      if (!_.value) return;
  ...
  return (
    xe(() => {
      Ge(
        ...
        g(),
        k(),
        (p.value = new ResizeObserver(k)),
        p.value.observe(e.value),
        e.value.addEventListener("scroll", S),
        t.subscribe("DS:scroll", ({ isDragging: O }) => O || S());
    }),
    Yn(() => {
...
function Nl(t, e) {
  ...
  const H = Fe(() => {
    var k;
    return (
      ((k = s.value[s.value.length - 2]) == null ? void 0 : k.path) ??
      n.value + "://"
    );
  });
  return (
...
function Wl(t, e, n = {}) {
  const { eventFilter: o = Ro, ...s } = n;
  return Me(t, Fo(o, e), s);
}
function Bs(t, e, n = {}) {
  const { eventFilter: o, ...s } = n,
    { eventFilter: c, pause: a, resume: d, isActive: i } = jl(o);
  return {
    stop: Wl(t, e, {
      ...s,
      eventFilter: c
...
function Hs(t, e, ...[n]) {
  const {
    ...
    i = [],
    u = ("ltr" in d && d.ltr) || (m => m),
    _ = ("rtl" in d && d.rtl) || (m => m);
  return (
    (a === "both" || a === "ltr") &&
      i.push(
        Bs(
...
function Zl(t, e, n = {}) {
  ...
  let c;
  const a = Xl(() => o && "MutationObserver" in o),
    d = () => {
      c && (c.disconnect(), (c = void 0));
    },
    i = Fe(() => {
      const m = cn(t),
        p = (Array.isArray(m) ? m : [m]).map(Yl).filter(zl);
      return new Set(p);
    }),
    u = Me(
      () => i.value,
      m => {
        d(),
          a.value &&
            m.size &&
            ((c = new MutationObserver(e)), m.forEach(p => c.observe(p, s)));
      },
      { immediate: !0, flush: "post" }
    ),
    _ = () => (c == null ? void 0 : c.takeRecords()),
    v = () => {
      u(), d();
    };
  return (
...
const Ql = (t, e, n) => {
    const o = Tr(t.id),
      s = yr(),
      c = o.getStore("metricUnits", !1),
      a = Fr(o, t.theme),
      d = n.i18n,
      i = t.locale ?? n.locale,
      u = o.getStore("adapter"),
      _ = y => (Array.isArray(y) ? y : Or),
      v = o.getStore("persist-path", t.persist),
      m = v ? o.getStore("path", t.path) : t.path,
      p = Lt({
        /**
         * Core properties
         * */
      ...
      h = Fe({
        ...
        set(y) {
          y &&
            ((p.sortActive = y.active),
            (p.sortColumn = y.column),
            (p.sortOrder = y.order));
        }
      });
    return Hs(e.view, g), Hs(e.sort, h), p;
  },
  ea = { class: "vuefinder__modal-layout__container" },
  ta = { class: "vuefinder__modal-layout__content" },
  na = { class: "vuefinder__modal-layout__footer" },
  Ke = {
    __name: "ModalLayout",
    setup(t) {
      const e = M(null),
        n = re("ServiceContainer");
      return (
        xe(() => {
              ...
              l("div", ea, [
                l(
                  "div",
                  {
                    ...
                    onMousedown:
                      s[0] || (s[0] = ot(c => r(n).modal.close(), ["self"]))
                  },
                  [
                    l(
                      "div",
                      ...
                      [
                        l("div", ta, [Tt(o.$slots, "default")]),
                        l("div", na, [Tt(o.$slots, "buttons")])
                      ],
                      512
                    )
                  ],
    ...
    b(
      "div",
      {
        class: le([
          ...
          { "vuefinder__action-message--hidden": !o.shown }
        ])
      },
      [
        t.$slots.default
          ? Tt(t.$slots, "default", { key: 0 })
          : (f(), b("span", ra, w(o.t("Saved.")), 1))
      ],
      2
    )
  );
}
const _t = /* @__PURE__ */ sa(oa, [["render", la]]),
  aa = {
...
const ca = { render: ia },
  da = { class: "vuefinder__modal-header" },
  ua = { class: "vuefinder__modal-header__icon-container" },
  va = {
  ...
  fa = { class: "vuefinder__about-modal__content" },
  _a = { class: "vuefinder__about-modal__main" },
  ma = {
    class: "vuefinder__about-modal__tabs",
    "aria-label": "Tabs"
  },
  pa = ["onClick", "aria-current"],
  ha = {
    key: 0,
    class: "vuefinder__about-modal__tab-content"
  },
  ga = { class: "vuefinder__about-modal__description" },
  ba = {
  ...
  ka = { class: "vuefinder__about-modal__description" },
  Sa = { class: "vuefinder__about-modal__settings" },
  xa = { class: "vuefinder__about-modal__setting flex" },
  $a = { class: "vuefinder__about-modal__setting-input" },
  Ca = { class: "vuefinder__about-modal__setting-label" },
  Ea = {
    for: "metric_unit",
    class: "vuefinder__about-modal__label"
  },
  Aa = { class: "vuefinder__about-modal__setting flex" },
  Ta = { class: "vuefinder__about-modal__setting-input" },
  Ma = { class: "vuefinder__about-modal__setting-label" },
  Da = {
    for: "large_icons",
    class: "vuefinder__about-modal__label"
  },
  Oa = { class: "vuefinder__about-modal__setting flex" },
  Va = { class: "vuefinder__about-modal__setting-input" },
  La = { class: "vuefinder__about-modal__setting-label" },
  Fa = {
    for: "persist_path",
    class: "vuefinder__about-modal__label"
  },
  Ra = { class: "vuefinder__about-modal__setting flex" },
  Ba = { class: "vuefinder__about-modal__setting-input" },
  Ha = { class: "vuefinder__about-modal__setting-label" },
  Ia = {
    for: "show_thumbnails",
    class: "vuefinder__about-modal__label"
  },
  Na = { class: "vuefinder__about-modal__setting" },
  Ua = { class: "vuefinder__about-modal__setting-input" },
  Pa = {
    for: "theme",
    class: "vuefinder__about-modal__label"
  },
  za = { class: "vuefinder__about-modal__setting-label" },
  qa = ["label"],
  ja = ["value"],
  Ga = {
    key: 0,
  ...
  Wa = { class: "vuefinder__about-modal__setting-input" },
  Ka = {
    for: "language",
    class: "vuefinder__about-modal__label"
  },
  Ya = { class: "vuefinder__about-modal__setting-label" },
  Ja = ["label"],
  Xa = ["value"],
  Za = {
    key: 2,
  ...
  Qa = { class: "vuefinder__about-modal__shortcuts" },
  ei = { class: "vuefinder__about-modal__shortcut" },
  ti = { class: "vuefinder__about-modal__shortcut" },
  ni = { class: "vuefinder__about-modal__shortcut" },
  si = { class: "vuefinder__about-modal__shortcut" },
  oi = { class: "vuefinder__about-modal__shortcut" },
  ri = { class: "vuefinder__about-modal__shortcut" },
  li = { class: "vuefinder__about-modal__shortcut" },
  ai = { class: "vuefinder__about-modal__shortcut" },
  ii = { class: "vuefinder__about-modal__shortcut" },
  ci = {
    key: 3,
    class: "vuefinder__about-modal__tab-content"
  },
  di = { class: "vuefinder__about-modal__description" },
  Bo = {
    __name: "ModalAbout",
    setup(t) {
      const e = re("ServiceContainer"),
        { setStore: n, clearStore: o } = e.storage,
        { t: s } = e.i18n,
        c = {
          ABOUT: "about",
          SETTINGS: "settings",
        ...
        _ = () => {
          (e.metricUnits = !e.metricUnits),
            (e.filesize = e.metricUnits ? js : qs),
            n("metricUnits", e.metricUnits),
            e.emitter.emit("vf-metric-units-saved");
        },
        v = () => {
          (e.compactListView = !e.compactListView),
            n("compactListView", e.compactListView),
            e.emitter.emit("vf-compact-view-saved");
        },
        m = () => {
          (e.showThumbnails = !e.showThumbnails),
            n("show-thumbnails", e.showThumbnails),
            e.emitter.emit("vf-show-thumbnails-saved");
        },
        p = () => {
          (e.persist = !e.persist),
            n("persist-path", e.persist),
            e.emitter.emit("vf-persist-path-saved");
        },
        { i18n: g } = re("VueFinderOptions"),
                    ...
                    b("div", ya, [
                      ...
                      l("div", Sa, [
                        l("fieldset", null, [
                          ...
                          l("div", Na, [
                            l("div", Ua, [l("label", Pa, w(r(s)("Theme")), 1)]),
                            l("div", za, [
                              ue(
                                l(
                                  "select",
                                  {
                                    ...
                                    "onUpdate:modelValue":
                                      k[4] ||
                                      (k[4] = S => (r(e).theme.value = S)),
                                    onChange:
                                      k[5] || (k[5] = S => u(S.target.value)),
                          ...
                          r(e).features.includes(r(de).LANGUAGE) &&
                          Object.keys(r(y)).length > 1
                            ? (f(),
                              b("div", Ga, [
                                l("div", Wa, [
  ...
  Ye = {
    ...
    setup(t, { emit: e }) {
      var u;
      const n = e,
        o = re("ServiceContainer"),
        { t: s } = o.i18n,
        c = M(!1),
        a = M(null),
        d = M((u = a.value) == null ? void 0 : u.strMessage);
      Me(d, () => (c.value = !1));
      const i = () => {
        n("hidden"), (c.value = !0);
      };
...
const Ho = { render: fi },
  _i = { class: "vuefinder__delete-modal__content" },
  mi = { class: "vuefinder__delete-modal__form" },
  pi = { class: "vuefinder__delete-modal__description" },
  hi = { class: "vuefinder__delete-modal__files vf-scrollbar" },
  gi = { class: "vuefinder__delete-modal__file" },
  bi = {
    key: 0,
  ...
  yi = { class: "vuefinder__delete-modal__file-name" },
  ki = { class: "vuefinder__delete-modal__warning" },
  ds = {
    __name: "ModalDelete",
    setup(t) {
      const e = re("ServiceContainer"),
        { t: n } = e.i18n,
        o = M(e.modal.data.items),
        s = M(""),
        c = () => {
          o.value.length &&
            e.emitter.emit("vf-fetch", {
              ...
              body: {
                items: o.value.map(({ path: a, type: d }) => ({
                  path: a,
                  type: d
                }))
              },
              ...
              l("div", _i, [
                l("div", mi, [
                  l(
                    "p",
                    pi,
                    w(r(n)("Are you sure you want to delete these files?")),
                    1
                  ),
                  l("div", hi, [
                    (f(!0),
...
const Io = { render: xi },
  $i = { class: "vuefinder__rename-modal__content" },
  Ci = { class: "vuefinder__rename-modal__item" },
  Ei = { class: "vuefinder__rename-modal__item-info" },
  Ai = {
    key: 0,
  ...
  Mi = { class: "vuefinder__rename-modal__item-name" },
  us = {
    __name: "ModalRename",
    setup(t) {
      const e = re("ServiceContainer"),
        { t: n } = e.i18n,
        o = M(e.modal.data.items[0]),
        s = M(e.modal.data.items[0].basename),
        c = M(""),
        a = () => {
          s.value != "" &&
            e.emitter.emit("vf-fetch", {
...
function Di(t) {
  const e = n => {
    n.code === Je.ESCAPE && (t.modal.close(), t.root.focus()),
      !t.modal.visible &&
        (t.fs.searchMode ||
          (n.code === Je.F2 &&
            t.features.includes(de.RENAME) &&
            (t.dragSelect.getCount() !== 1 ||
              t.modal.open(us, { items: t.dragSelect.getSelected() })),
          n.code === Je.F5 &&
          ...
          n.code === Je.DELETE &&
            (!t.dragSelect.getCount() ||
              t.modal.open(ds, { items: t.dragSelect.getSelected() })),
          n.metaKey && n.code === Je.BACKSLASH && t.modal.open(Bo),
          n.metaKey &&
            n.code === Je.KEY_F &&
            t.features.includes(de.SEARCH) &&
            ((t.fs.searchMode = !0), n.preventDefault()),
          n.metaKey &&
            n.code === Je.KEY_E &&
            ((t.showTreeView = !t.showTreeView),
            t.storage.setStore("show-tree-view", t.showTreeView)),
          n.metaKey &&
            n.code === Je.ENTER &&
            ((t.fullScreen = !t.fullScreen), t.root.focus()),
          n.metaKey &&
            n.code === Je.KEY_A &&
...
const No = { render: Vi },
  Li = { class: "vuefinder__new-folder-modal__content" },
  Fi = { class: "vuefinder__new-folder-modal__form" },
  Ri = { class: "vuefinder__new-folder-modal__description" },
  Bi = ["placeholder"],
  Uo = {
...
const Po = { render: Ii },
  Ni = { class: "vuefinder__new-file-modal__content" },
  Ui = { class: "vuefinder__new-file-modal__form" },
  Pi = { class: "vuefinder__new-file-modal__description" },
  zi = ["placeholder"],
  qi = {
    __name: "ModalNewFile",
    setup(t) {
...
const zo = { render: Gi },
  Wi = { class: "vuefinder__upload-modal__content" },
  Ki = {
    key: 0,
  ...
  Ji = ["disabled"],
  Xi = ["disabled"],
  Zi = { class: "vuefinder__upload-modal__file-list vf-scrollbar" },
  Qi = ["textContent"],
  ec = { class: "vuefinder__upload-modal__file-info" },
  tc = { class: "vuefinder__upload-modal__file-name hidden md:block" },
  nc = { class: "vuefinder__upload-modal__file-name md:hidden" },
  sc = {
    key: 0,
    class: "ml-auto"
  },
  oc = ["title", "disabled", "onClick"],
  rc = {
    key: 0,
    class: "py-2"
  },
  ...
  ac = {
    ...
    setup(t) {
      ...
      function H(T, R = null) {
        (R = R ?? (T.webkitRelativePath || T.name)),
          y.addFile({
            name: R,
            type: T.type,
            data: T,
      ...
      function G() {
        y.cancelAll({ reason: "user" }),
          m.value.forEach(T => {
            T.status !== s.DONE &&
              ((T.status = s.CANCELED), (T.statusName = n("Canceled")));
          }),
          (g.value = !1);
      }
      function V(T) {
        g.value ||
          (y.removeFile(T.id, "removed-by-user"), m.value.splice(E(T.id), 1));
      }
      function $(T) {
        if (!g.value) {
        ...
        xe(async () => {
          (y = new Sr({
            ...
            onBeforeFileAdded(C, U) {
              if (U[C.id] != null) {
                const ee = E(C.id);
                m.value[ee].status === s.PENDING &&
                  (p.value = y.i18n("noDuplicates", { fileName: C.name })),
                  (m.value = m.value.filter(se => se.id !== C.id));
              }
              return (
                m.value.push({
                  id: C.id,
            ...
            y.on("upload", () => {
              ...
              (U.opts.method = C.method),
                (U.opts.endpoint = C.url + "?" + new URLSearchParams(C.params)),
                (U.opts.headers = C.headers),
                delete C.headers["Content-Type"],
                (g.value = !0),
                m.value.forEach(P => {
                  P.status !== s.DONE &&
                    ((P.percent = null),
                    (P.status = s.UPLOADING),
                    (P.statusName = n("Pending upload")));
                });
            }),
          ...
          function T(C, U) {
            U.isFile && U.file(P => C(U, P)),
              U.isDirectory &&
                U.createReader().readEntries(P => {
                  P.forEach(ee => {
                    T(C, ee);
                  });
                });
          ...
          d.value.addEventListener("change", R),
            i.value.addEventListener("change", R);
        }),
        zs(() => {
              ...
              l("div", null, [
                ...
                l("div", Wi, [
                      ...
                      h.value
                        ? (f(),
                          b(
                            "div",
                            Ki,
                            w(r(n)("Release to drop these files.")),
                            1
                          ))
                        : (f(),
                          b(
                  ...
                  l("div", Zi, [
                            ...
                            [
                              ...
                              l("div", ec, [
                                l(
                                  "div",
                                  tc,
                                  w(r(Wn)(C.name, 40)) + " (" + w(C.size) + ")",
                                  1
                                ),
                                l(
                                  "div",
                                  nc,
                                  w(r(Wn)(C.name, 16)) + " (" + w(C.size) + ")",
                                  1
                                ),
                                l(
                                  "div",
                                  ...
                                  (R[3] = [
                                    l(
                                      "svg",
                                      {
                                        ...
                                        stroke: "currentColor",
                                        class:
                                          "vuefinder__upload-modal__file-remove-icon"
                                      },
                                      [
                                        l("path", {
                                          "stroke-linecap": "round",
                    ...
                    m.value.length
                      ? I("", !0)
                      : (f(), b("div", rc, w(r(n)("No files selected!")), 1))
                  ]),
                  p.value.length
                    ? (f(),
                      K(
...
const qo = { render: cc },
  dc = { class: "vuefinder__unarchive-modal__content" },
  uc = { class: "vuefinder__unarchive-modal__items" },
  vc = { class: "vuefinder__unarchive-modal__item" },
  fc = {
    key: 0,
    class:
  ...
  mc = { class: "vuefinder__unarchive-modal__item-name" },
  pc = { class: "vuefinder__unarchive-modal__info" },
  jo = {
              ...
              l("div", dc, [
                l("div", uc, [
                  ...
                  l(
                    "p",
                    pc,
                    w(r(n)("The archive will be unarchived at")) +
                      " (" +
                      w(r(e).fs.data.dirname) +
                      ")",
                    1
                  ),
                  s.value.length
...
const Go = { render: gc },
  bc = { class: "vuefinder__archive-modal__content" },
  wc = { class: "vuefinder__archive-modal__form" },
  yc = { class: "vuefinder__archive-modal__files vf-scrollbar" },
  kc = { class: "vuefinder__archive-modal__file" },
  Sc = {
    key: 0,
  ...
  $c = { class: "vuefinder__archive-modal__file-name" },
  Cc = ["placeholder"],
  Wo = {
    __name: "ModalArchive",
    setup(t) {
        ...
        a = () => {
          c.value.length &&
            e.emitter.emit("vf-fetch", {
              ...
              body: {
                items: c.value.map(({ path: d, type: i }) => ({
                  path: d,
                  type: i
                })),
                name: o.value
...
const Nc = { render: Ic },
  ...
  Xc = { class: "pl-2" },
  Zc = { class: "dark:bg-gray-700 bg-gray-200 text-xs px-2 py-1 rounded" },
  Qc = { class: "vuefinder__toolbar__controls" },
  ed = ["title"],
  td = ["title"],
  nd = {
    __name: "Toolbar",
      ...
      Me(
        ...
        () => {
          e.fullScreen
            ? (document.querySelector("body").style.overflow = "hidden")
            : (document.querySelector("body").style.overflow = ""),
            n("full-screen", e.fullScreen),
            e.emitter.emit("vf-fullscreen-toggle");
        }
      );
      const d = () => {
        (e.view = e.view === "list" ? "grid" : "list"),
          s.refreshSelection(),
          n("viewport", e.view);
      };
      return (i, u) => (
        ...
        b("div", Uc, [
          c.value.length
            ...
            : (f(),
              b("div", Pc, [
                r(e).features.includes(r(de).NEW_FOLDER)
                  ? (f(),
                    b(
                      "div",
                      {
                        ...
                        onClick:
                          u[0] ||
                          (u[0] = _ =>
                            r(e).modal.open(Uo, { items: r(s).getSelected() }))
                      },
                      [z(r(No))],
                      8,
                      zc
                  ...
                  : I("", !0),
                r(e).features.includes(r(de).NEW_FILE)
                  ? (f(),
                    b(
                      "div",
                      {
                        ...
                        onClick:
                          u[1] ||
                          (u[1] = _ =>
                            r(e).modal.open(qi, { items: r(s).getSelected() }))
                      },
                      [z(r(Po))],
                      8,
                      qc
                  ...
                  : I("", !0),
                r(e).features.includes(r(de).RENAME)
                  ? (f(),
                    b(
                      "div",
                      {
                        ...
                        onClick:
                          ...
                          (u[2] = _ =>
                            r(s).getCount() !== 1 ||
                            r(e).modal.open(us, { items: r(s).getSelected() }))
                      },
                      [
                        z(
                          r(Io),
                  ...
                  : I("", !0),
                r(e).features.includes(r(de).DELETE)
                  ? (f(),
                    b(
                      "div",
                      {
                        ...
                        onClick:
                          ...
                          (u[3] = _ =>
                            !r(s).getCount() ||
                            r(e).modal.open(ds, { items: r(s).getSelected() }))
                      },
                      [
                        z(
                          r(Ho),
                  ...
                  : I("", !0),
                r(e).features.includes(r(de).UPLOAD)
                  ? (f(),
                    b(
                      "div",
                      {
                        ...
                        onClick:
                          u[4] ||
                          (u[4] = _ =>
                            r(e).modal.open(ac, { items: r(s).getSelected() }))
                      },
                      [z(r(zo))],
                      8,
                      Wc
                  ...
                  : I("", !0),
                r(e).features.includes(r(de).UNARCHIVE) &&
                r(s).getCount() === 1 &&
                (r(s).getSelected()[0].mime_type ||
                  r(s).getSelected()[0].mimeType) === "application/zip"
                  ? (f(),
                    b(
                      "div",
                      {
                        ...
                        onClick:
                          ...
                          (u[5] = _ =>
                            !r(s).getCount() ||
                            r(e).modal.open(jo, { items: r(s).getSelected() }))
                      },
                      [
                        z(
                          r(qo),
                  ...
                  : I("", !0),
                r(e).features.includes(r(de).ARCHIVE)
                  ? (f(),
                    b(
                      "div",
                      {
                        ...
                        onClick:
                          ...
                          (u[6] = _ =>
                            !r(s).getCount() ||
                            r(e).modal.open(Wo, { items: r(s).getSelected() }))
                      },
                      [
                        z(
                          r(Go),
          ...
          l("div", Qc, [
            r(e).features.includes(r(de).FULL_SCREEN)
              ? (f(),
                b(
                  "div",
                  {
...
const ld = { render: rd },
  ad = { class: "vuefinder__move-modal__content" },
  id = { class: "vuefinder__move-modal__description" },
  cd = { class: "vuefinder__move-modal__files vf-scrollbar" },
  dd = { class: "vuefinder__move-modal__file" },
  ud = {
    key: 0,
  ...
  md = { class: "vuefinder__move-modal__target-directory" },
  pd = { class: "vuefinder__move-modal__target-path" },
  hd = { class: "vuefinder__move-modal__selected-items" },
  Kn = {
    __name: "ModalMove",
    setup(t) {
      const e = re("ServiceContainer"),
        { t: n } = e.i18n,
        o = M(e.modal.data.items.from),
        s = M(""),
        c = () => {
          o.value.length &&
            e.emitter.emit("vf-fetch", {
            ...
            l("div", null, [
              ...
              l("div", ad, [
                l(
                  "p",
                  id,
                  w(r(n)("Are you sure you want to move these files?")),
                  1
                ),
                l("div", cd, [
                  (f(!0),
                  ...
                  d[4] ||
                    (d[4] = l(
                      "svg",
                      {
                        xmlns: "http://www.w3.org/2000/svg",
                        class:
                          "vuefinder__move-modal__icon vuefinder__move-modal__icon--dir",
                        fill: "none",
                        viewBox: "0 0 24 24",
                        stroke: "currentColor",
                        "stroke-width": "1"
...
const zd = { render: Pd },
  qd = { class: "vuefinder__breadcrumb__container" },
  jd = ["title"],
  Gd = ["title"],
  Wd = ["title"],
  Kd = ["title"],
  Yd = { class: "vuefinder__breadcrumb__list" },
  Jd = {
    key: 0,
    class: "vuefinder__breadcrumb__hidden-list"
  },
  Xd = { class: "relative" },
  Zd = ["onDragover", "onDragleave", "onDrop", "title", "onClick"],
  Qd = { class: "vuefinder__breadcrumb__search-mode" },
  eu = ["placeholder"],
  tu = { class: "vuefinder__breadcrumb__hidden-dropdown" },
  nu = ["onDrop", "onClick"],
  su = { class: "vuefinder__breadcrumb__hidden-item-content" },
  ou = { class: "vuefinder__breadcrumb__hidden-item-text" },
  ru = {
    __name: "Breadcrumb",
    setup(t) {
      const e = re("ServiceContainer"),
      ...
      Me(a, V => {
        ...
        let x = 0,
          ...
          T = 5,
          R = 1;
        e.fs.limitBreadcrumbItems(T),
          dt(() => {
            for (
              let C = $.length - 1;
              C >= 0 && !(x + $[C].offsetWidth > a.value - 40);
              C--
            )
      ...
      const u = (V, $ = null) => {
          V.preventDefault(),
            (o.isDraggingRef.value = !1),
            m(V),
            $ ?? ($ = e.fs.hiddenBreadcrumbs.length - 1);
        ...
        v = V => {
          V.preventDefault(),
            e.fs.isGoUpAvailable()
              ? ((V.dataTransfer.dropEffect = "copy"),
                V.currentTarget.classList.add(
                  "bg-blue-200",
                  "dark:bg-slate-600"
                ))
              : ((V.dataTransfer.dropEffect = "none"),
                (V.dataTransfer.effectAllowed = "none"));
        },
        m = V => {
          V.preventDefault(),
      ...
      const k = M(null),
        S = () => {
          e.features.includes(de.SEARCH) &&
            ((e.fs.searchMode = !0), dt(() => k.value.focus()));
        },
        O = Is("", 400);
      Me(O, V => {
        e.emitter.emit("vf-toast-clear"),
          e.emitter.emit("vf-search-query", { newQuery: V });
      }),
        Me(
          () => e.fs.searchMode,
          V => {
            ...
            ? (f(),
              b(
                ...
                [
                  z(r(Cd), {
                    onClick:
                      $[3] || ($[3] = x => r(e).emitter.emit("vf-fetch-abort"))
                  })
                ],
                8,
                Kd
                ...
                l("div", null, [
                  z(r(Td), {
                    ...
                    onClick:
                      $[7] ||
                      ($[7] = x =>
                        r(e).emitter.emit("vf-fetch", {
                          params: { q: "index", adapter: r(e).fs.adapter }
                        }))
                  })
                ]),
                l("div", Yd, [
                  r(e).fs.hiddenBreadcrumbs.length
                    ? ue(
                        (f(),
                        b("div", Jd, [
                          $[13] ||
                            ...
                            l(
                              "span",
                              {
                                onDragenter:
                                  $[8] ||
                                  ($[8] = x =>
                                    r(e).fs.toggleHiddenBreadcrumbs(!0)),
                                onClick:
                                  $[9] ||
                                  ($[9] = x =>
                                    r(e).fs.toggleHiddenBreadcrumbs()),
                        ...
                        (x, A) => (
                          ...
                          b("div", { key: A }, [
                            ...
                            l(
                              ...
                              {
                                onDragover: T =>
                                  A === r(e).fs.breadcrumbs.length - 1 || v(T),
                                onDragleave: T =>
                                  A === r(e).fs.breadcrumbs.length - 1 || m(T),
                                onDrop: T =>
                                  A === r(e).fs.breadcrumbs.length - 1 ||
                                  _(T, A),
...
function cu(t, e) {
  ...
  return (
    a.days &&
      !i &&
      (i = c + a.days + ":" + it(a.hours) + ":" + it(a.minutes) + ":" + d),
    a.hours &&
      !i &&
      (i = c + (n ? it(a.hours) : a.hours) + ":" + it(a.minutes) + ":" + d),
    i || (i = c + (n ? it(a.minutes) : a.minutes) + ":" + d),
    o && (i += "." + it(a.ms, 3)),
    i
  );
}
var du = cu;
const uu = /* @__PURE__ */ lu(du),
  Ko = (t, e = null) =>
    new Date(t * 1e3).toLocaleString(e ?? navigator.language ?? "en-US"),
  vu = ["onClick"],
  fu = {
    __name: "Toast",
    setup(t) {
      const e = re("ServiceContainer"),
        { getStore: n } = e.storage,
        o = M(n("full-screen", !1)),
        s = M([]),
        c = i =>
          i === "error"
...
const Cu = { render: $u },
  Eu = { class: "vuefinder__drag-item__container" },
  Au = { class: "vuefinder__drag-item__count" },
  Tu = {
    __name: "DragItem",
    props: {
      count: {
    ...
    setup(t) {
      const e = t;
      return (n, o) => (
        f(), b("div", Eu, [z(r(Cu)), l("div", Au, w(e.count), 1)])
      );
    }
  },
  Mu = { class: "vuefinder__text-preview" },
  Du = { class: "vuefinder__text-preview__header" },
  Ou = ["title"],
  Vu = { class: "vuefinder__text-preview__actions" },
  Lu = {
    key: 0,
        ...
        b("div", Mu, [
          l("div", Du, [
            l(
              ...
              w(r(u).modal.data.item.basename),
              9,
              Ou
            ),
            l("div", Vu, [
              a.value
                ...
                : I("", !0),
              r(u).features.includes(r(de).EDIT)
                ? (f(),
                  b(
                    "button",
                    {
  ...
  Bu = { class: "vuefinder__image-preview" },
  Hu = { class: "vuefinder__image-preview__header" },
  Iu = ["title"],
  Nu = { class: "vuefinder__image-preview__actions" },
  Uu = { class: "vuefinder__image-preview__image-container" },
  Pu = ["src"],
  zu = {
    __name: "Image",
    emits: ["success"],
            ...
            .toBlob(m => {
              ...
              p.set("file", m),
                o.requester
                  ...
                  .then(g => {
                    (i.value = s("Updated.")),
                      (c.value.src = o.requester.getPreviewUrl(
                        o.modal.data.adapter,
                        o.modal.data.item
                      )),
                      _(),
                      n("success");
          ...
          b("div", Bu, [
            l("div", Hu, [
              l(
                ...
                w(r(o).modal.data.item.basename),
                9,
                Iu
              ),
              l("div", Nu, [
                d.value
                  ...
                  : I("", !0),
                r(o).features.includes(r(de).EDIT)
                  ? (f(),
                    b(
                      "button",
                      {
            ...
            l("div", Uu, [
              l(
                "img",
                {
                  ...
                  src: r(o).requester.getPreviewUrl(
                    r(o).modal.data.adapter,
                    r(o).modal.data.item
                  ),
                  alt: ""
                },
  ...
  qu = { class: "vuefinder__default-preview" },
  ju = { class: "vuefinder__default-preview__header" },
  Gu = ["title"],
  Wu = {
    __name: "Default",
    emits: ["success"],
    setup(t, { emit: e }) {
      const n = re("ServiceContainer"),
        o = e;
      return (
        xe(() => {
          o("success");
          ...
          b("div", qu, [
            l("div", ju, [
              l(
                ...
                w(r(n).modal.data.item.basename),
                9,
                Gu
              )
            ]),
  ...
  Ku = { class: "vuefinder__video-preview" },
  Yu = ["title"],
  Ju = {
  ...
  Zu = {
    ...
    setup(t, { emit: e }) {
      const n = re("ServiceContainer"),
        o = e,
        s = () =>
          n.requester.getPreviewUrl(n.modal.data.adapter, n.modal.data.item);
      return (
        xe(() => {
          o("success");
        }),
          ...
          b("div", Ku, [
            ...
            l("div", null, [
              l("video", Ju, [
                ...
                a[0] ||
                  (a[0] = X(" Your browser does not support the video tag. "))
              ])
            ])
          ])
        )
  ...
  Qu = { class: "vuefinder__audio-preview" },
  ev = ["title"],
  tv = {
  ...
  ov = { class: "vuefinder__pdf-preview" },
  rv = ["title"],
  lv = ["data"],
  av = ["src", "srcdoc"],
  iv = {
  ...
  cv = { class: "vuefinder__preview-modal__content" },
  dv = { key: 0 },
  uv = { class: "vuefinder__preview-modal__loading" },
  vv = {
    key: 0,
  ...
  _v = { class: "vuefinder__preview-modal__details" },
  mv = { class: "font-bold" },
  pv = { class: "font-bold pl-2" },
  hv = {
    key: 1,
  ...
  Yo = {
    ...
    setup(t) {
      const e = re("ServiceContainer"),
        ...
        s = d =>
          (
            (e.modal.data.item.mime_type || e.modal.data.item.mimeType) ??
            ""
          ).startsWith(d),
        c = e.features.includes(de.PREVIEW);
      c || (o.value = !0);
      const a = d => {
        let i = "";
        return (
          d.artist && ((i += `${d.artist}`), d.title && (i += ` - ${d.title}`)),
          i
        );
      };
      return (d, i) => (
        ...
        K(Ke, null, {
          buttons: Q(() => [
            ...
            r(e).features.includes(r(de).DOWNLOAD)
              ? (f(),
                b(
                  "a",
                  {
          ...
          default: Q(() => [
            ...
            (
              (r(e).modal.data.item.mime_type ||
                r(e).modal.data.item.mimeType) ??
              ""
            ).startsWith("audio")
              ? (f(), b("div", fv, w(a(r(e).modal.data.item)), 1))
              : I("", !0),
            l("div", _v, [
              l("div", null, [
...
const Jo = { render: wv },
  yv = ["data-type", "data-item", "data-index"],
  Mn = {
    __name: "Item",
    props: /* @__PURE__ */ Qt(
      {
    ...
    setup(t) {
      ...
      Zl(
        c,
        ([h]) => {
          h.attributeName === "data-item" &&
            (s.value = JSON.parse(c.value.dataset.item));
        },
        {
          attributes: !0
        }
      ...
      const a = h => {
        ...
        d = {
          mounted(h, y, E, H) {
            E.props.draggable &&
              (h.addEventListener("dragstart", k => i(k, y.value)),
              h.addEventListener("dragover", k => _(k, y.value)),
              h.addEventListener("drop", k => u(k, y.value)));
          },
          beforeUnmount(h, y, E, H) {
            E.props.draggable &&
              (h.removeEventListener("dragstart", i),
              h.removeEventListener("dragover", _),
              h.removeEventListener("drop", u));
          }
        },
        i = (h, y) => {
          if (h.altKey || h.ctrlKey || h.metaKey) return h.preventDefault(), !1;
          (n.isDraggingRef.value = !0),
            h.dataTransfer.setDragImage(o.dragImage.$el, 0, 15),
            (h.dataTransfer.effectAllowed = "all"),
            (h.dataTransfer.dropEffect = "copy"),
            h.dataTransfer.setData("items", JSON.stringify(n.getSelected()));
        },
        u = (h, y) => {
        ...
        _ = (h, y) => {
          h.preventDefault(),
            !y ||
            y.type !== "dir" ||
            n.getSelection().find(E => E === h.currentTarget)
              ? ((h.dataTransfer.dropEffect = "none"),
                (h.dataTransfer.effectAllowed = "none"))
              : (h.dataTransfer.dropEffect = "copy");
        };
      let v = null,
        m = !1;
      const p = () => {
        ...
        g = h => {
          ...
          else return (m = !1), a(s.value), clearTimeout(v), !1;
          v = setTimeout(() => {
          ...
          b(
            "div",
            {
              ...
              onContextmenu:
                ...
                (y[3] = ot(
                  E =>
                    r(e).emitter.emit("vf-contextmenu-show", {
                      event: E,
            ...
            [
              Tt(h.$slots, "default"),
              r(e).pinnedFolders.find(E => E.path === s.value.path)
                ? (f(),
                  K(r(Jo), {
                    key: 0,
  ...
  kv = { class: "vuefinder__explorer__container" },
  Sv = {
    key: 0,
    class: "vuefinder__explorer__header"
  },
  xv = { class: "vuefinder__explorer__drag-item" },
  $v = { class: "vuefinder__explorer__item-list-content" },
  Cv = { class: "vuefinder__explorer__item-list-name" },
  Ev = { class: "vuefinder__explorer__item-name" },
  Av = { class: "vuefinder__explorer__item-path" },
  Tv = { class: "vuefinder__explorer__item-list-content" },
  Mv = { class: "vuefinder__explorer__item-list-name" },
  Dv = ["title"],
  Ov = { key: 0 },
  Vv = { key: 0 },
  Lv = { class: "vuefinder__explorer__item-size" },
  Fv = { key: 0 },
  Rv = { class: "vuefinder__explorer__item-date" },
  Bv = { class: "vuefinder__explorer__item-grid-content" },
  Hv = ["data-src", "alt"],
  Iv = {
    key: 2,
    class: "vuefinder__explorer__item-extension"
  },
  Nv = { class: "vuefinder__explorer__item-title break-all" },
  Uv = {
    __name: "Explorer",
    setup(t) {
      const e = re("ServiceContainer"),
        { t: n } = e.i18n,
        o = p => (p == null ? void 0 : p.substring(0, 3)),
        s = M(null),
        c = M(""),
        a = e.dragSelect;
      let d;
      ...
      const i = Fe(() => ({
        ...
        u = (p = !0) => {
          let g = [...e.fs.data.files.filter(k => !k.isFile)],
            h = [...e.fs.data.files.filter(k => k.isFile)],
            y = i.value.column,
            E = i.value.order === "asc" ? 1 : -1;
          if (!p) return [...g, ...h];
          const H = (k, S) =>
            typeof k == "string" && typeof S == "string"
              ? k.toLowerCase().localeCompare(S.toLowerCase())
              : k < S
              ? -1
              : k > S
              ? 1
          ...
          return (
            i.value.active &&
              ((g = g.slice().sort((k, S) => H(k[y], S[y]) * E)),
              (h = h.slice().sort((k, S) => H(k[y], S[y]) * E))),
            [...g, ...h]
          );
        },
        _ = p => {
          e.sortActive && i.value.column === p
            ? ((e.sortActive = i.value.order === "asc"),
              (e.sortColumn = p),
              (e.sortOrder = "desc"))
            : ((e.sortActive = !0), (e.sortColumn = p), (e.sortOrder = "asc"));
        },
        v = p => {
          let g = p.basename;
          return (
                        ...
                        [
                          ...
                          ue(
                            ...
                            [
                              [
                                Pe,
                                i.value.active && i.value.column === "file_size"
                              ]
                            ]
                          )
                        ]
                      ...
                      ye(
                        ...
                        (h, y) => (
                          ...
                          K(
                            ...
                            1032,
                            ["item", "index", "dragImage", "onUpdate:item"]
                          )
                        )
                      ),
                      256
                                  ...
                                  l("div", Mv, [
                                    ...
                                    l(
                                      ...
                                      [
                                        X(w(h.basename) + " ", 1),
                                        (
                                          (h.mime_type || h.mimeType) ??
                                          ""
                                        ).startsWith("audio") && h.artist
                                          ? (f(),
                                            b("span", Ov, [
                                              X(" (" + w(h.artist) + " ", 1),
                                              h.title
                                ...
                                l("div", null, [
                                  l("div", Bv, [
                                    (
                                      (h.mime_type || h.mimeType) ??
                                      ""
                                    ).startsWith("image") && r(e).showThumbnails
                                      ? (f(),
                                        b(
                                          "img",
                                          {
  ...
  qv = {
    ...
    setup(t) {
      const e = re("ServiceContainer"),
        ...
        d = Fe(() =>
          a.items.filter(v => v.key == null || e.features.includes(v.key))
        );
      ...
      const i = {
          ...
          pinFolder: {
            title: () => n("Pin Folder"),
            action: () => {
              (e.pinnedFolders = e.pinnedFolders.concat(s.value)),
      ...
      e.emitter.on("vf-search-query", ({ newQuery: v }) => {
        ...
        e.emitter.on(
          "vf-contextmenu-show",
          ({ event: v, items: m, target: p = null }) => {
            if (((a.items = []), c.value))
              if (p)
                a.items.push(i.openDir),
                  e.emitter.emit("vf-context-selected", [p]);
              else return;
            else
              !p && !c.value
                ? (a.items.push(i.refresh),
                  a.items.push(i.selectAll),
                  a.items.push(i.newfolder),
                  e.emitter.emit("vf-context-selected", []))
                : m.length > 1 && m.some(g => g.path === p.path)
                ? (a.items.push(i.refresh),
                  a.items.push(i.archive),
                  a.items.push(i.delete),
                  e.emitter.emit("vf-context-selected", m))
                : (p.type === "dir"
                    ? (a.items.push(i.open),
                      e.pinnedFolders.findIndex(g => g.path === p.path) !== -1
                        ? a.items.push(i.unpinFolder)
                        : a.items.push(i.pinFolder))
                    : (a.items.push(i.preview), a.items.push(i.download)),
                  a.items.push(i.rename),
                  (p.mime_type || p.mimeType) === "application/zip"
                    ? a.items.push(i.unarchive)
                    : a.items.push(i.archive),
                  a.items.push(i.delete),
                  e.emitter.emit("vf-context-selected", [p]));
            _(v);
      ...
      const _ = v => {
        const m = e.dragSelect.area.value,
          p = e.root.getBoundingClientRect(),
          g = m.getBoundingClientRect();
        let h = v.clientX - p.left,
          y = v.clientY - p.top;
        (a.active = !0),
          dt(() => {
            var S;
            const E =
              (S = o.value) == null ? void 0 : S.getBoundingClientRect();
            let H = (E == null ? void 0 : E.height) ?? 0,
              k = (E == null ? void 0 : E.width) ?? 0;
            (h = g.right - v.pageX + window.scrollX < k ? h - k : h),
              (y = g.bottom - v.pageY + window.scrollY < H ? y - H : y),
              (a.positions = {
                left: h + "px",
                top: y + "px"
              });
                            ...
                            b(
                              "a",
                              {
                                ...
                                onClick:
                                  m[0] ||
                                  (m[0] = g =>
                                    r(e).emitter.emit("vf-contextmenu-hide"))
                              },
...
const Yv = { render: Kv },
  Jv = { class: "vuefinder__status-bar__wrapper" },
  Xv = { class: "vuefinder__status-bar__storage" },
  Zv = ["title"],
  Qv = { class: "vuefinder__status-bar__storage-icon" },
  ef = ["value"],
  tf = { class: "vuefinder__status-bar__info" },
  nf = { key: 0 },
  sf = { class: "vuefinder__status-bar__selected-count" },
  ...
  cf = {
    ...
    setup(t) {
      ...
      const d = u => {
          const _ = e.selectButton.multiple
            ? s.getSelected().length > 0
            : s.getSelected().length === 1;
          return u.isActive() && _;
        },
        i = Fe(() => {
          const u = e.selectButton.multiple
            ? s.getSelected().length > 0
            : s.getSelected().length === 1;
                  ...
                  l(
                    ...
                    [
                      ...
                      b(
                        ...
                        null,
                        ye(
                          r(e).fs.data.storages,
                          v => (f(), b("option", { value: v }, w(v), 9, ef))
                        ),
                        256
                      ))
                    ],
              ...
              a.value.length
                ? (f(),
                  b(
                    "span",
                    nf,
                    w(r(e).fs.data.files.length) + " items found. ",
                    1
                  ))
                : I("", !0),
              l(
                ...
                sf,
                w(
                  r(e).dragSelect.getCount() > 0
                    ? r(n)("%s item(s) selected.", r(e).dragSelect.getCount())
                    : ""
                ),
                1
              )
                ...
                b(
                  "button",
                  {
                    ...
                    onClick:
                      _[1] ||
                      (_[1] = v =>
                        r(e).selectButton.click(r(s).getSelected(), v))
                  },
                  w(r(n)("Select")),
                  11,
                  lf
...
const bf = { class: "vuefinder__folder-loader-indicator" },
  wf = {
    key: 1,
        ...
        return (
          ...
          b("div", bf, [
            s.value
              ...
              : (f(),
                b("div", wf, [
                  o.value && (u = c()) != null && u.folders.length
                    ? (f(),
                      K(r(er), {
                        key: 0,
  ...
  yf = { class: "vuefinder__treesubfolderlist__item-content" },
  kf = ["onClick"],
  Sf = ["title", "onClick"],
  xf = { class: "vuefinder__treesubfolderlist__item-icon" },
  $f = { class: "vuefinder__treesubfolderlist__subfolder" },
  Cf = {
    ...
    setup(t) {
      ...
      const c = Fe(() => {
        var a;
        return (
          ((a = e.treeViewData.find(d => d.path === o.path)) == null
            ? void 0
            : a.folders) || []
        );
      });
  ...
  Ef = { class: "vuefinder__treestorageitem__loader" },
  Af = {
  ...
  Tf = { class: "vuefinder__folder-indicator" },
  Mf = { class: "vuefinder__folder-indicator--icon" },
  Df = {
  ...
  Of = { class: "vuefinder__treeview__header" },
  Vf = { class: "vuefinder__treeview__pinned-label" },
  Lf = { class: "vuefinder__treeview__pin-text text-nowrap" },
  Ff = {
    key: 0,
    class: "vuefinder__treeview__pinned-list"
  },
  Rf = { class: "vuefinder__treeview__pinned-item" },
  Bf = ["onClick"],
  Hf = ["title"],
  If = ["onClick"],
  Nf = { key: 0 },
  Uf = { class: "vuefinder__treeview__no-pinned" },
  Pf = { class: "vuefinder__treeview__storage" },
  zf = {
    __name: "TreeView",
    setup(t) {
      const e = re("ServiceContainer"),
        { t: n } = e.i18n,
        { getStore: o, setStore: s } = e.storage,
        c = M(190),
        a = M(o("pinned-folders-opened", !0));
      Me(a, _ => s("pinned-folders-opened", _));
      const d = _ => {
          (e.pinnedFolders = e.pinnedFolders.filter(v => v.path !== _.path)),
            e.storage.setStore("pinned-folders", e.pinnedFolders);
        },
        i = _ => {
          const v = _.clientX,
            m = _.target.parentElement,
            p = m.getBoundingClientRect().width;
          m.classList.remove("transition-[width]"),
            m.classList.add("transition-none");
          const g = y => {
              (c.value = p + y.clientX - v),
                c.value < 50 && ((c.value = 0), (e.showTreeView = !1)),
                c.value > 50 && (e.showTreeView = !0);
            },
            h = () => {
              const y = m.getBoundingClientRect();
              (c.value = y.width),
                m.classList.add("transition-[width]"),
                m.classList.remove("transition-none"),
            ...
            [
              l(
                "div",
                {
                  onClick:
                    v[0] ||
                    (v[0] = m => (r(e).showTreeView = !r(e).showTreeView)),
                  class: le([
  ...
  qf = { class: "vuefinder__main__content" },
  jf = {
    __name: "VueFinder",
    props: /* @__PURE__ */ Qt(
      {
    ...
    setup(t, { emit: e }) {
      const n = e,
        ...
        s = Mt(t, "view"),
        c = Mt(t, "sort"),
        a = Ql(o, { view: s, sort: c }, re("VueFinderOptions"));
      br("ServiceContainer", a);
      const { setStore: d } = a.storage,
        i = M(null);
      a.root = i;
        ...
        a.emitter.on(
          ...
          ({
            ...
            a.requester
              ...
              .then(H => {
                (a.fs.adapter = H.adapter),
                  a.persist && ((a.fs.path = H.dirname), d("path", a.fs.path)),
                ...
                [
                  l(
                    "div",
                    {
                      ...
                      style: dn(
                        r(a).fullScreen ? "" : "max-height: " + t.maxHeight
                      ),
                      onMousedown:
                        p[0] ||
                        (p[0] = g => r(a).emitter.emit("vf-contextmenu-hide")),
                      onTouchstartPassive:
                        p[1] ||
                        (p[1] = g => r(a).emitter.emit("vf-contextmenu-hide"))
                    },
                    [z(nd), z(ru), l("div", qf, [z(zf), z(Uv)]), z(cf)],
                    38
                  ),
                  z(
                    wr,
  ...
  t_ = {
    ...
    install(t, e = {}) {
      ...
      (e.locale = e.locale ?? n ?? "en"),
        t.provide("VueFinderOptions", e),
        t.component("VueFinder", jf);
    }
  };
export { t_ as default };
